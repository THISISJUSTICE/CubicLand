...
public class DVScenePersistor : MonoBehaviour
{
    #region Variables
    [SerializeField] private int _flag;
    public int Flag { get => _flag; }

    private static Dictionary<int, DVScenePersistor> _instances;
    ...
    {
        if (_instances == null)
            _instances = new Dictionary<int, DVScenePersistor>();
    ...
    private bool CheckInstanceDifferent(DVScenePersistor persistor) {
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        {
            var persistors = GameObject.FindObjectsByType<DVScenePersistor>(FindObjectsSortMode.None);
