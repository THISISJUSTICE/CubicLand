...
{
    public class PlayerBackFollower : MonoBehaviour
    {
        #region Variables
        ...
        private float GetFollowDistance()
        {
            ...
            float distance = Mathf.Max(
                Utils.GetBaseLineHA(maxWidth, _mainCam.fieldOfView),
