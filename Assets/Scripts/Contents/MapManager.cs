...
namespace CustomTIJI.CubicLand
{
    public class MapManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < 10; i++)
                CubeCreator.Instance.AddRandomGolemCube(playerInfo);
            GolemCore player = CubeCreator.Instance.CreatePlayer(playerInfo);
        ...
        private IEnumerator TempFall()
        {
            ...
            {
                var obstacle = CubeCreator.Instance.CreateObstacleCube(status);
                ...
                yield return Helper.YieldCache.GetWaitForSeconds(0.02f);
            }
        }
        #endregion
    }
