...
namespace CustomTIJI.CubicLand.Cube
{
    public struct CubeData
    {
        ...
        public CubeData(StatusPoint statusPoint, Vector3Int shapePosition, bool isCore, Color color)
        { 
        ...
        public CubeData MakeChildData(Vector3Int shapePosition)
        {
            ...
            return new CubeData(StatusPoint.MakeChildStatus(), shapePosition, false, color);
        }
