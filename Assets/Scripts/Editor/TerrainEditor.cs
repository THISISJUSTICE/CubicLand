...
namespace Commar.CubicLand
{
    public class TerrainEditor : EditorWindow
    {
        ...
        private void ResetTerrain()
        {
            ...
            tData.size = new Vector3(resol * Configs.CUBE_BASE_LENGHT, Configs.CUBE_BASE_LENGHT, resol * Configs.CUBE_BASE_LENGHT);
        ...
        private void SetTerrainBorder()
        {
            ...
            TerrainData tData = _terrain.terrainData;
            int resol = tData.heightmapResolution;
            tData.size = new Vector3(resol * Configs.CUBE_BASE_LENGHT, (float)_heightCount * Configs.CUBE_BASE_LENGHT, resol * Configs.CUBE_BASE_LENGHT);
            float[,] heights = tData.GetHeights(0, 0, resol, resol);
