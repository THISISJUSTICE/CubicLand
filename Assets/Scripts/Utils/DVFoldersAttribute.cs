...
public class DVFoldersAttribute : PropertyAttribute
{
    public string TargetVariableName { get; }

    public DVFoldersAttribute(string targetVariableName) => TargetVariableName = targetVariableName;
}

#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(DVFoldersAttribute))]
public class DVFoldersAttributeEditor : PropertyDrawer
{
    private enum TargetListType { Array, List, ETC };

    private DVFoldersAttribute _foldersAttribute;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (_once)
        {
            ...
            _foldersAttribute = (DVFoldersAttribute)attribute;
