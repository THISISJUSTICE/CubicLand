...
{
    internal static class PerfomanceConfigs
    {
        internal static int MaxFrameRate
        {
            get
            {
        ...
        internal static long MemoryLimit
        {
            get
            {
#if UNITY_EDITOR || UNITY_STANDALONE_WIN
        ...
        internal static int AnimationFrame
        {
            get
            {
                // 기기의 Frame에 맞게 조정
        ...
        internal static long EstimateGameObjectMemory(GameObject go, bool instMat)
        {
            long memorySize = 0;
        ...
        private static long GetMaterialMemory(GameObject go)
        {
            ...
            const long estMaterialMemory = 3 * Configs.KB; // 추정치
